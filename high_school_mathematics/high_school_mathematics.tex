...
\newcommand{\df}{\noindent \makebox[\linewidth]{\textcolor{magenta}{\dotfill}}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Environments:
...
%	\listoftables
	...
	\mainmatter
	\part{مبانی}
	\include{./TeX_files/logic}
	\include{./TeX_files/sets}
	\include{./TeX_files/numbers}
	\include{./TeX_files/proofs}
	
	\part{جبر}
	\include{./TeX_files/algebra}
	\include{./TeX_files/equations}
	\include{./TeX_files/functions}
	\include{./TeX_files/exp-log}
	\include{./TeX_files/sequences}
	
	\part{مثلثات}
	\include{./TeX_files/trig1}
	\include{./TeX_files/trig2}
	
	\part{هندسه}
	\include{./TeX_files/geometry}
	\include{./TeX_files/analytic-geom}
	\include{./TeX_files/solid-geom}
	
	\part{جبر خطی}
	\include{./TeX_files/matrices}
	\include{./TeX_files/systems}
	
	\part{ریاضیات گسسته}
	\include{./TeX_files/combinatorics}
	\include{./TeX_files/graph}
	\include{./TeX_files/number-theory}
	...
	\part{حسابان}
	\include{./TeX_files/limits}
	\include{./TeX_files/derivatives}
	\include{./TeX_files/integrals}
	
	\backmatter
	\part{ضمیمه‌ها}
	\include{./TeX_files/solutions}
